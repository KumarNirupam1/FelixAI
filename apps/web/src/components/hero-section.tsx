...
export function HeroSection() {
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto overflow-hidden py-0 px-4 w-full h-[600px] md:h-[800px] lg:h-[900px] md:px-0"
    >
      {/* SVG Background */}
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        ...
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          FelixAI lives in your tray. One hotkey, instant help — every exchange
          stored in your self-hosted Cognee memory graph.
        </p>
      </div>

      <div className="flex flex-col md:flex-row justify-center items-center gap-4 relative z-10">
        <Link href="#get-started" onClick={(e) => { e.preventDefault(); document.getElementById("get-started")?.scrollIntoView({ behavior: "smooth" }); }}>
        ...
        <Link href="#architecture-section" onClick={(e) => { e.preventDefault(); document.getElementById("architecture-section")?.scrollIntoView({ behavior: "smooth" }); }}>
          <Button className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 flex items-center gap-2">
            <span>How Cognee works</span>
          </Button>
        </Link>
      </div>
    </section>
